      ...
      <section className="relative max-w-7xl mx-auto px-6 pt-10 pb-6">
        <div className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-[32px] p-8 md:p-12 relative overflow-hidden">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <span className="bg-white/10 text-slate-100 text-xs px-3 py-1.5 rounded-full">Privacidad primero</span>
            <span className="bg-white/10 text-slate-100 text-xs px-3 py-1.5 rounded-full">Progreso medible</span>
          </div>
        </div>
      </section>
